    ...
    <table>
        ...
        <tr>
            ...
            <td>
                ...
                <a href="<?php echo site_url('C_masterpos_subpos/update_pos/'). $id_anggota['id_transfer']; ?>">Edit</a>
                <a href="<?php echo site_url('C_masterpos_subpos/delete_pos/'). $id_anggota['id_transfer']; ?>">Hapus</a>
            </td>
        </tr>
        <?php endforeach; ?>
    </table>
